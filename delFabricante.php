...
<head>
    ...
    <title>Deletar Fabricante</title>
</head>
<body>
<div class="content">
	<div class="col4">
	...
	<!-------------------------------------------- INICIO PHP --------------------------------------------------->
		...
		<form method="POST" action="script/delDesenv.php">
			...
			<br />
            <input type="submit" class="btnEnviar" id="enviar" name="enviar" value="Excluir" class="bt-enviar" />
        </form>
	</div>
